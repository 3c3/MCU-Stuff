...
#define radians(x) x * 0.017453293
...
bool TinyGPS::term_complete()
{
	if (_is_checksum_term)
	{
		ubyte checksum = 16 * from_hex(_term[0]) + from_hex(_term[1]);
		if (checksum == _parity)
		{
			if (_gps_data_good)
			{
...
void TinyGPS::crack_datetime(int *year, ubyte *month, ubyte *day,
ubyte *hour, ubyte *minute, ubyte *second, ubyte *hundredths)
{
